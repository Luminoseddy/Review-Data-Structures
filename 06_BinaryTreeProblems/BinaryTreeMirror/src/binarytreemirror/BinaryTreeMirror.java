...
/**
 * 
 * Searching for the minimum value will have us looking inside the left subtree. 
 * For every node, the left child will have a smaller value than its node value. 
 * 
 * 
 */
public class BinaryTreeMirror {
    ...
    public static void mirror(Node<Integer> root) {
        ...
        /* Recursively calling mirror on every node. */
